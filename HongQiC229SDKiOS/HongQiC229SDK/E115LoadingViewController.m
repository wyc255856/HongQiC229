...
@implementation E115LoadingViewController
{
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [back setImage:[self createImageByName:@"e115ImageResource/e115loading.jpg"]];
...
- (void)jumpMain{
    HQ115MainViewController*vc = [[HQ115MainViewController alloc] init];
