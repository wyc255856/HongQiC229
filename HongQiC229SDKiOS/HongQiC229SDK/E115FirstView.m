...
- (void)setCarImage{
    ...
    [_carImage setImage:[self createImageByName:[NSString stringWithFormat:@"e115-36images/hq115-%d",total]]];
...
- (void)changeImage{
    NSString *imageName = [NSString stringWithFormat:@"e115-36images/hq115-%d",total];
