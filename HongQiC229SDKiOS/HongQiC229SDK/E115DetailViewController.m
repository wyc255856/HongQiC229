...
@interface E115DetailViewController ()<UIScrollViewDelegate,UIWebViewDelegate>
...
@implementation E115DetailViewController
...
- (void)setback{
    ...
    backView = [[UIView alloc] initWithFrame:CGRectMake(25, 40, kScreenWidth-50, kScreenHeight-40)];
    backView.backgroundColor = [UIColor clearColor];
    UIImageView *backImage = [[UIImageView alloc] initWithFrame:self.view.bounds];
    [backImage setImage:[self createImageByName:@"e115ImageResource/e115neirongbeijingtu"]];
